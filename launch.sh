...
echo    '"volumes": [' >> $FILEPATH/docker.json
echo    '{' >> $FILEPATH/docker.json
echo    '"containerPath": "/nfsdir",' >> $FILEPATH/docker.json
echo    '"hostPath": "/nfsdir",' >> $FILEPATH/docker.json
echo    '"mode":"RW"' >> $FILEPATH/docker.json
echo    '}' >> $FILEPATH/docker.json
echo    ']' >> $FILEPATH/docker.json
echo	'},' >> $FILEPATH/docker.json
...
echo  '"command":' "\"$FILEPATH/innerSh.sh\"" >> $FILEPATH/docker.json
echo '}' >> $FILEPATH/docker.json
